...
//	}
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		//hopdongdatcoc
		http.authorizeRequests().antMatchers(URL.GET_ALL_Hopdongdatcoc).hasAuthority(Role.ROLE_ADMIN);
		
		//hopdongkygui
		http.authorizeRequests().antMatchers(URL.GET_ALL_Hopdongkygui).hasAuthority(Role.ROLE_ADMIN);
