package com.herokuapp.realestatebk.util;
...
public class URL {
	...
	public static final String DELETE_Batdongsan = "/batdongsan/{id}";
	...
	public static final String ADD_Nhanvien = "/nhanvien";
	...
	public static final String UPDATE_Yeucaukhachhang = "/yeucaukhachhang";
	public static final String DELETE_Yeucaukhachhang = "/yeucaukhachhang/{id}";
