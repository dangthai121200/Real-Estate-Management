...
public class FormKhachhang {
	...
	public void setTrangthai(byte trangthai) {
		...
		if (Integer.valueOf(this.khid) == null) {
			...
			khachhang = new Khachhang( cmnd, diachi, diachitt, email, gioitinh, hoten,
				 loaikh, mota, ngaysinh, sodienthoai, trangthai);
		} else {
			// use for update nhanvien
			khachhang = new Khachhang( khid, cmnd, diachi, diachitt, email, gioitinh, hoten,
					 loaikh, mota, ngaysinh, sodienthoai, trangthai);
		}
		return khachhang;
	}
